...
4. **Обновлен GitHub репозиторий**
   - Все исправления загружены (коммит f8186cb)
...
**Последнее обновление:** 14.12.2024 - Исправлена логика bet vs raise  
**Версия:** v1.1 - Production Ready с исправленной hand history 