...
4. **Обновлен GitHub репозиторий**
   - Все исправления загружены (коммит e9ac273)
...
**Последнее обновление:** 14.12.2024 - Исправлена логика bet vs raise и клиентские кнопки  
**Версия:** v1.2 - Production Ready с полностью исправленной hand history и клиентской логикой 