...
6. **Обновлен GitHub репозиторий**
   - Все исправления загружены (коммит 9519798)
...
**Последнее обновление:** 14.12.2024 - Добавлен визуальный редактор разметки sprite sheet карт  
**Версия:** v1.7 - Production Ready с инструментом для настройки координат карт 